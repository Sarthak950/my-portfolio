...
var Bounce = /** @class */ (function () {
    ...
    Bounce.prototype.render = function (_a) {
        ...
        setStyle(contentEl, {
            '-transform': "translate3d(".concat(-(offset.x + x), "px, ").concat(-(offset.y + y), "px, 0)"),
        });
        if (x) {
            track.xAxis.show();
            var scaleRatio = size.container.width / (size.container.width + Math.abs(x));
            setStyle(track.xAxis.thumb.element, {
                '-transform': "translate3d(".concat(track.xAxis.thumb.offset, "px, 0, 0) scale3d(").concat(scaleRatio, ", 1, 1)"),
        ...
        if (y) {
            ...
            setStyle(track.yAxis.thumb.element, {
                '-transform': "translate3d(0, ".concat(track.yAxis.thumb.offset, "px, 0) scale3d(1, ").concat(scaleRatio, ", 1)"),
